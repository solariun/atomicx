...
public:
    ...
    uint8_t GetAllarmCounter (size_t threadId)
    {
        ...
        Serial.println ((size_t) pwtdItem);
        Serial.flush ();
    ...
    void run() noexcept override
    {
        do
        {
            for (auto& wtdItem : WtdgControl)
            {
                ...
                {
                    Serial.print ("WTD: THR ");
                    Serial.print (wtdItem.nThreadId);
                    Serial.print (", ALLARM ");
                    Serial.print (wtdItem.recoverCounter+1);
                    Serial.println (" UP.");
...
public:
    ThreadAllarm(uint32_t nNice) :  atomicx (::GetStackSize(20), 10)
    {
        ...
        Watchdog::instance.AttachThread (*this, 5000, true);
    }
...
public:
    ThreadAllarm2(uint32_t nNice) :  atomicx (::GetStackSize(20), 10)
    {
        ...
        Watchdog::instance.AttachThread (*this, 6000, true);
    }

    const char* GetName () override
    {
        return "ThreadAllarm2";
    }
